...
#Given a text file, order the lines in lexicographical order (i.e. Z-A instead of A-Z).
...
echo "Lines in $input_file have been reordered in lexicographical order."
